...
function playerStep() {
	...
	|| (place_meeting(x, y+global.yspeed+1, prtMovingPlatformSolid) && !place_meeting(x, y, prtMovingPlatformSolid))
	{
	    ...
	    var maxID;
	    maxID = -1;
	    while place_meeting(x, y+global.yspeed+1, prtMovingPlatformSolid) && endCheck == false
	    {
	        maxID += 1;
	...
	{
	    if ground == true && isSlide == false && ((global.keyJumpPressed && global.keyDown) || global.keySlidePressed)
